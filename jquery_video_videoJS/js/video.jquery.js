/* ===========================================================
    VIDEO JQUERY v0.1 - Nilo César - 16/10/2015
/* ===========================================================



/* ===========================================================
    VIDEO JQUERY - Nilo César - 16/10/2015
/* =========================================================== */
...
(function (f) {
    ...
    return (function e(t, n, r) {
        ...
        74: [function (_dereq_, module, exports) {
            ...
            "../../component.js": 58,
            "./caption-settings-menu-item.js": 73,
...
(function ($) {
    ...
    public.video_jquery = function (options) {
        ...
        (function () {
            var control = private.settings.control;
    ...
    public.stop = function () {
        private.self.currentTime(0);
        private.self.pause();
    };

    public.currentTime = function (_currentTime) {
        private.self.currentTime(_currentTime);
    }
    ...
    public.start = function () {
        $(obj).trigger({
            ...
            message: "start",
            time: new Date(),
            timeTotal: private.settings.timeTotal,
            timeCurrent: private.settings.timeCurrent
        });
    };

    public.paused = function () {
        $(obj).trigger({
            type: "paused",
            message: "paused",
            time: new Date(),
    ...
    public.timeTotal = function () {
        return private.settings.timeTotal;
    };

    public.timeCurrent = function () {
        return private.settings.timeCurrent;
    };
    ...
    private.localInit = function () {
        console.log("default");

        $(obj).append('<video id="videoContainer" class="video-js vjs-default-skin" height="' + private.settings.height + '" width="' + private.settings.width + '" controls><source src="' + private.settings.path + '" type="video/mp4"></video>');

        var player = videojs('videoContainer', {
            "controls": private.settings.skin,
            "autoplay": private.settings.autoplay,
            "preload": true
        }, function () {
            ...
            this.on('timeupdate', function () {
                private.settings.timeTotal = player.duration();
                private.settings.timeCurrent = player.currentTime();
                private.settings.paused = player.paused();
                public.timeProgress();

                if (player.paused() && !pauseStatus) {
                    public.paused();
                    pauseStatus = true;
                } else {
                    pauseStatus = false;
    ...
    /* ===========================================================
       ...
       ---------------- CONTROLE API YOUTUBE -----------------------
   

    /* =========================================================== */

    private.youtubelInit = function () {
        ...
        var _autoplay = 1;
        if (!private.settings.autoplay) _autoplay = 0;

        var _skin = 1;
        if (!private.settings.skin) _skin = 0;
        ...
        window.onYouTubeIframeAPIReady = function () {
            ...
            player = new YT.Player($(obj).attr("id"), {
                height: private.settings.height,
                width: private.settings.width,
                videoId: private.settings.path,
                playerVars: {
                    'autoplay': _autoplay,
                    'showinfo': _skin,
                    'controls': _skin
        ...
        function onPlayerReady(event) {
            ...
            private.settings.timeTotal = player.getDuration();
            ...
            function updateTime() {
                var oldTime = private.settings.timeCurrent;
        ...
        ///
        private.self.play = function () {
            player.playVideo();
        }

        private.self.pause = function () {
            player.pauseVideo();
        }

        private.self.currentTime = function (_currentTime) {
    ...
    private.vimeolInit = function () {

        $(obj).append('<iframe id="player1" src="https://player.vimeo.com/video/' + private.settings.path + '?api=1&autoplay=' + private.settings.autoplay + '&player_id=player1" width=' + private.settings.width + ' height=' + private.settings.height + ' frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
